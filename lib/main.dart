import 'package:add_transaction_new/Controllers/db_helper.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:add_transaction_new/static.dart' as Static;
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    var controller = new MaskedTextController(mask: '00.000.000');
